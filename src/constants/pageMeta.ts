...
export const SITE_KEYWORDS =
  "Njoh Simplice Junior, software developer, web developer, WordPress developer, SEO specialist, freelance developer, Yaoundé, Cameroon, React developer, Laravel developer, web design, mobile app development";
